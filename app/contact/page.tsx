      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-14 md:py-24 grid lg:grid-cols-2 gap-10 md:gap-14 items-center">
        <div>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-xl">
            <div className="rounded-2xl border p-4"><div className="text-2xl font-semibold">50+</div><div className="text-sm text-slate-500">Project</div></div>
            <div className="rounded-2xl border p-4"><div className="text-2xl font-semibold">24/7</div><div className="text-sm text-slate-500">Support</div></div>
            <div className="rounded-2xl border p-4"><div className="text-2xl font-semibold">100%</div><div className="text-sm text-slate-500">Modern UI</div></div>
          </div>
        </div>
        <div id="form" className="rounded-3xl border shadow-sm p-5 sm:p-8 bg-white">

  ...
  return (
      ...
      <section className="max-w-7xl mx-auto px-6 py-24 grid lg:grid-cols-2 gap-14 items-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="rounded-3xl border p-6 shadow-sm mt-8">
            <div className="text-3xl font-semibold">50+</div>
            <div className="text-slate-500 mt-2">Ide & Proyek</div>
          </div>
          <div className="rounded-3xl border p-6 shadow-sm -mt-2">
            <div className="text-3xl font-semibold">100%</div>
            <div className="text-slate-500 mt-2">Semangat Belajar</div>
          </div>
          <div className="rounded-3xl border p-6 shadow-sm mt-6">
      ...
      <section id="story" className="border-t">
        <div className="max-w-7xl mx-auto px-6 py-20 grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border p-5"><div className="font-semibold">Vision</div><p className="text-slate-600 mt-2">Menjadi tim kreatif yang menghadirkan produk digital bernilai tinggi.</p></div>
            <div className="rounded-2xl border p-5"><div className="font-semibold">Mission</div><p className="text-slate-600 mt-2">Membangun solusi modern, cepat, dan mudah digunakan.</p></div>
          </div>
        </div>
      </section>
    </main>
